...
interface FeedbackIssueInfoLeftProps {
    issuesData: IssueItem[];
    selectedRow: IssueItem | null;
}

const FeedbackIssueInfoLeft: React.FC<FeedbackIssueInfoLeftProps> = ({ issuesData, selectedRow }) => {
...
export default FeedbackIssueInfoLeft